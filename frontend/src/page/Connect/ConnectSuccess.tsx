...
const ConnectSuccess = () => {
  ...
  return (
    <ConnectLayout image="/images/onboarding.svg"
      title={<>You are Connected <CheckOutlined style={{ fontSize: 22, color: "#fb8500" }} /></>}
      subtitle="Welcome to Squad. Select one of the two options to contiue.">
      <Row style={{ display: "flex", flexDirection: "column", width: "fit-content" }}>
        <SquadButton
